...
namespace lcu
{
	inline namespace algorithms
	{
		...
		public:
			 ...
			 */
			static char* CopyOf(const char* p_pPrimitiveCharT);
			/**
			 * @return A copy of p_pPrimitiveCharT
			 * @complexity o(LengthOf(p_pPrimitiveCharT+1))
			 */
			static char* CopyOf(const char* p_pPrimitiveCharT, size_t p_size);
			// H
			 ...
			 */
			static size_t LengthOf(const char* p_pPrimitiveCharT);
			// M
			template <typename Type>
