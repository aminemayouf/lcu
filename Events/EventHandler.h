...
namespace LCU {
	inline namespace Events {
		...
		public:
			...
			static EventHandlerForMemberFunctions<Class, Types...>* Bind(Class* caller, void (Class::*p_callback)(Types ...));
		...
		template <class Class, typename ...Types>
		EventHandlerForMemberFunctions<Class, Types...>* EventHandler::Bind(Class* p_caller, void (Class::* p_callback)(Types ...)) {
