...
namespace lcu
{
	inline namespace algorithms
	{
		...
		public:
			...
			// B
			static size_t BinarySearch(Type* p_pArray, size_t p_size, const Type& p_value);
			// S
			static size_t SequentialSearch(Type* p_pArray, size_t p_size, const Type& p_value);
		};
